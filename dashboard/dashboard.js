    ...
    Dashboard.prototype.handleCollapseEvent = function()
    {
    	...
    	this.$.on('click', '.collapse-panel', function()
		{
			if ($(this).children().hasClass("home_uncollapse")) {
				$(this).children().removeClass("home_uncollapse").addClass("home_collapse").closest(".panel").children(".panel-body:first").slideDown();
			} else {
				$(this).children().removeClass("home_collapse").addClass("home_uncollapse").closest(".panel").children(".panel-body:first").slideUp();
			}
